...
7. Every pipeline run is one commit with a conventional message (`refresh: 2026-W28 (mid-week)`, `report: 2026-W28`, etc.) followed by a `git push` to origin/main. Commit and push together — never leave a green pipeline sitting locally.
